                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select class="form-select @error('sub_document_type_id') is-invalid @enderror" 
                                        id="sub_document_type_id" name="sub_document_type_id">
                                        <option value="">Select Sub Type</option>
                                        @foreach($subDocumentTypes as $subType)
                                            <option value="{{ $subType->id }}" 
                                                {{ old('sub_document_type_id') == $subType->id ? 'selected' : '' }} 
                                ...
                                <!-- FBOs -->
                                <div class="col-md-6 mb-4">
                                    <label class="form-label">Associated FBOs</label>
                                ...
                                <div class="col-md-3 mb-4">
                                    ...
                                    <input type="number" class="form-control @error('season_year') is-invalid @enderror" 
                                        ...
                                        min="2018" max="2050" value="{{ old('season_year', date('Y')) }}">
                                    @error('season_year')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled mb-0">
                                ...
                                <li class="mb-0">
                                    <i class="feather-check-circle text-success me-2"></i>
                                    <small>Choose appropriate document type</small>
                                </li>
                            </ul>
                        </div>
                    </div>
