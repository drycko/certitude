...
<head>
    ...
    <!--! BEGIN: Favicon-->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('vendor/duralux-admin/assets/images/favicon.ico') }}">
    <!--! END: Favicon-->
    <!--! BEGIN: Bootstrap CSS-->
            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    ...
                    <div class="card-body p-sm-5 text-center">
                        ...
                        <div class="mt-5">
                            <a href="{{ route('tenant.dashboard') }}" class="btn btn-light-brand w-100">Back Home</a>
                        </div>
                    </div>
                </div>
            </div>
