    ...
    <div class="content-area" data-scrollbar-target="#psScrollbarInit">
        ...
        <div class="content-area-body">
                    ...
                    @if ($fileTypes->isEmpty())
                        <div class="col-12">
                            <div class="alert alert-info mb-0" role="alert">
                                No folders found, please add some folders.
                            </div>
                        </div>
                    @else
                        ...
                        <div class="card mb-4 stretch stretch-full">
                            <div class="card-body p-0">
                                <a href="javascript:void(0);" class="d-flex align-items-center border-bottom p-3" data-bs-toggle="offcanvas" data-bs-target="#fileFolderDetailsOffcanvas">
                                    <div class="p-2 avatar-image bg-gray-200 rounded-3">
                                        <img src="{{ asset('vendor/duralux-admin/assets/images/file-icons/undefined.png') }}" alt="" class="img-fluid">
                                    </div>
                                    <div class="ms-3">
                                        <span class="d-block">{{ $fileType->name }}</span>
                                        <span class="fs-10 text-muted text-uppercase d-block">{{ $fileType->files_count }} Files</span>
                                    </div>
                                </a>
            ...
            <div class="project-section">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div class="me-4">
                        <h2 class="fs-16 fw-bold mb-1">Files</h2>
                        <div class="fs-12 text-muted text-truncate-1-line">Recent files <span class="fs-11 fw-normal text-muted">(Last access 24 min ago)</span></div>
                    </div>
                    <a href="javascript:void(0);" class="btn btn-sm btn-light-brand">View More</a>
                </div>
                <div class="card mb-0">
                    ...
                    <div class="text-center py-5">
                        ...
                        @can('upload files')
                        <a href="{{ route('files.create') }}" class="btn btn-dolesa-primary">
