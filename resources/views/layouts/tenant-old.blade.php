...
<head>
    ...
    <!-- Metis Admin CSS -->
    <script type="module" crossorigin src="{{ asset('vendor/metis-admin/dist-modern/assets/vendor-bootstrap-C9iorZI5.js') }}"></script>
    <script type="module" crossorigin src="{{ asset('vendor/metis-admin/dist-modern/assets/vendor-charts-DGwYAWel.js') }}"></script>
    <script type="module" crossorigin src="{{ asset('vendor/metis-admin/dist-modern/assets/vendor-ui-CflGdlft.js') }}"></script>
    <link rel="stylesheet" crossorigin href="{{ asset('vendor/metis-admin/dist-modern/assets/main-BQhM7myw.css') }}">
        ...
        <header class="admin-header">
            <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand d-flex align-items-center" href="{{ route('tenant.dashboard') }}">
                        <img src="{{ asset('asset/images/logo.svg') }}" alt="Logo" height="32" class="d-inline-block align-text-top me-2">
