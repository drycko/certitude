...
class PowerBiLinkType extends Model
{
    ...
    {
        return $this->hasMany(PowerBiLink::class, 'power_bi_link_type_id');
    }
    ...
    {
        return $this->belongsToMany(UserGroup::class, 'user_group_power_bi_link_types', 'power_bi_link_type_id', 'user_group_id');
    }
    ...
    /**
     * Parent summary link type relationship
     */
    ...
    /**
     * Child summary link types relationship
     */
    ...
    /**
     * Check if this is a root (parent) summary link type
     */
    ...
    /**
     * Check if this summary link type has children
     */
    ...
    /**
     * Get the root parent of this summary link type
     */
    public function getRoot(): SummaryLinkType
    {
        if ($this->isRoot()) {
            return $this;
        }
    ...
    /**
     * Scope to get only root summary link types
     */
    ...
    /**
     * Scope to get only child summary link types
     */
    ...
    /**
     * Scope active summary link types
     */
