...
class DocumentType extends Model
{
    ...
    {
        return $this->belongsToMany(UserGroup::class, 'user_group_document_types', 'document_type_id', 'user_group_id');
    }
    ...
    {
        return $this->hasMany(UserActivity::class, 'record_id')->where('table_name', 'document_types');
    }
    ...
    /**
     * Parent document type relationship
     */
    ...
    /**
     * Child document types relationship
     */
    ...
    /**
     * Check if this is a root (parent) document type
     */
    ...
    /**
     * Check if this document type has children
     */
    ...
    /**
     * Get the root parent of this document type
     */
    public function getRoot(): DocumentType
    {
        if ($this->isRoot()) {
            return $this;
        }
    ...
    /**
     * Scope to get only root document types
     */
    ...
    /**
     * Scope to get only child document types
     */
