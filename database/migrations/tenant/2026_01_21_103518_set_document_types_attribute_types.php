...
return new class extends Migration
{
     ...
     * Run the migrations.
     * 
     * Sets appropriate attribute_type values for document types:
     * - 'grower': Only 'Quality Assessment Reports' - visible to grower role users only
     * - 'customer': All other document types - visible to customer role users
     */
    public function up(): void
    {
        // Set ALL document types to 'customer' as default
    ...
    public function down(): void
    {
        ...
        DB::table('document_types')->update(['attribute_type' => 'customer']);
    }
};
