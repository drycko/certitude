...
return [
    ...
    */
    ...
    'email' => env('MAIL_REPLY_TO_ADDRESS', 'support@ubix.co.za'),
    'admin_email' => env('APP_ADMIN_EMAIL', 'admin@ubix.co.za'),
    'developer_email' => env('APP_DEVELOPER_EMAIL', 'support@ubix.co.za'),
    ...
    'website' => env('APP_WEBSITE', 'https://certitude.co.za'),
    'base_domain' => env('APP_BASE_DOMAIN', 'certitude.local'),
